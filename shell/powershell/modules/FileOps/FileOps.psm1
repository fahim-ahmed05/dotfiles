...
function Clear-DesktopFolder { Clear-Folder -Source "Desktop" }
function Clear-DownloadsFolder { Clear-Folder -Source "Downloads" }
function Clear-TrashFolder { Clear-Folder -Empty }
